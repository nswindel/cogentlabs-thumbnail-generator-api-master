...
*This service has been tested with NodeJS version 20.19.0. It has not been confirmed to work in other versions.*
...
*If you are using Apple Silicon, then you need to run tests like this:*

```
MONGOMS_ARCH=x64 npm run test
```
